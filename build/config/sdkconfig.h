...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partitions_user.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partitions_user.csv"
...
#define CONFIG_SPIRAM_MALLOC_RESERVE_INTERNAL 8192
